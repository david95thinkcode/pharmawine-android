                ...
                public void onClick(View v) {
                    ...
                    if(listType.equals(MEDICAL_TEAM)) {
                        ...
                        if(medicalTeam.isValid()) {
                            i.putExtra(ClientDetailsActivity.CLIENT_TYPE_KEY, ClientDetailsActivity.CLIENT_MEDICAL_TEAM);
                    ...
                    if(listType.equals(PHARMACY)) {
                        ...
                        if(pharmacy.isValid()) {
                            i.putExtra(ClientDetailsActivity.CLIENT_TYPE_KEY, ClientDetailsActivity.CLIENT_PHARMACY);
